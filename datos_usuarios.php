...
<body>
	<div class="cuerpo">
		...
		<div class="container">
			<article>
				Para registrarse debes llenar este pequeño formulario
			</article>
			<div class="articulos">
				<article>
					<form action="Back-end/enviar_dpersona.php" method="post">
						<input type="hidden" name="id" value="<?php echo $row['id'] ?>">
						<div class="formulario">
							<div class="input">
								<div>
									<label for="Nombre">Nombres: </label>
									<input type="text" name="Nombre" id="Nombre" placeholder="Ej; Mariana">
								</div>
								<div>
									<label for="Apellido">Apellidos: </label>
									<input type="text" name="Apellido" id="Apellido" placeholder="Ej: Angel Torres">
								</div>
							</div>
							<div class="input">
								...
								<div class="Fecha_datos">
									<div>
										...
										<div>
											...
											<select aria-label="Día" name="Día" id="Día" plac>
